...
# These should be updated as new ciphers are drafted
ciphers_tls = {
    ...
    # RFC8446 - TLS1.3 specification (next 5)
    ...
    # Special cipher to indicate client's support for downgrade prevention - rfc7507
    # b'\x56\x00': 'TLS_FALLBACK_SCSV',  # ClientHello property
    ...
    # RFC-harkins-tls-dragonfly-03 (next 4)
    ...
    b'\xFF\x02': 'TLS_RSA_GOST89MAC',  # Official name unknown
...
def get_cipher_list(protocol):
    if protocol == Protocol.TLS:
        return list(ciphers_tls)
    elif protocol == Protocol.SSL2:
        return list(ciphers_ssl2)
